...
public class PolandNotation {
    ...
    public static List<String> parseSuffixExpressionList(List<String> ls) {
        ...
        for (String item: ls) {
            ...
            if (item.matches("\\d+")) {
                ...
                //当item的优先级小于或者等于s1栈顶的运算符，将s1栈顶的运算符弹出并加入到s2中，再次转到(4,1)与s1中新的栈顶运算符相比较
                //问题：我们缺少一个比较优先级高低的方法
        ...
        return s2;//注意因为是存储到List，因此按顺序输出就是对应的逆波兰表达式(后缀表达式)
    }
     ...
     * 3.将5入栈
     * 4.接下来是*运算符，因弹出5和7，计算出7*5=35，将35入栈
     * 5.将6入栈
