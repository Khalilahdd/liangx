...
public class HuffmanCode {
    ...
    public static void main(String[] args) {
        ...
        //测试压缩文件
//        String srcFile = "E:\\素材\\优质的壁纸\\1 (1).jpg";
//        String dstFile = "E:\\素材\\优质的壁纸\\1.zip";
//
//        zipFile(srcFile, dstFile);
//        System.out.println("压缩文件成功");

        //测试解压文件
        String zipFile = "E:\\\\素材\\\\优质的壁纸\\\\1.zip";
        String dstFile = "E:\\\\素材\\\\优质的壁纸\\\\1 (0).jpg";
...
//        System.out.println("huffmanCodeBytes = " + Arrays.toString(huffmanCodeBytes));
    ...
    // 重写先转成 哈夫曼编码对应的二进制的字符串 "1010100010111111110..."=》对照哈夫曼编码 =》 "i like like like java do you like a java"
    //2.哈夫曼编码对应的二进制字符串 "1010100010111111110..."=》对照哈夫曼编码 =》 "i like like like java do you like a java"
    ...
    private static byte[] decode(Map<Byte, String> huffmanCodes, byte[] huffmanBytes) {
        ...
        //1.先得到 huffmanBytes 对应的二进制的字符串，形式1010100010111...
...
//        return null;
        ...
        //当for 循环结束后，我们list中就存放了所以的字符 "i like like like java do you like a java";
    ...
    private static String byteToBitString(boolean flag, byte b) {
        ...
        //如果是正数我们还存在补高位
        if (flag) {
            temp |= 256;//temp 1 =》 000 （按位或） 256 1 0000 0000   0000 0001
        }
    ...
    //2.在生成哈夫曼编码表示，需要去拼接路径，定义一个StringBuilder存储某个叶子结点的路径
    ...
    /**
     * 功能：将传入的node结点的所以叶子结点的哈夫曼编码得到，并存放到huffmanCodes集合
     *
     * @param node          传入结点
