...
public class DoubleLinkedListDemo {
    ...
    public static void main(String[] args) {
        ...
        //添加
        HeroNode2 heroNode2 = new HeroNode2(5, "鲁智深", "花和尚");
...
class DoubleLinkedList {
    ...
    //添加一个节点到双向链表的最后，双向链表的节点内容修改和单向链表一样
    //只是节点类型改成HeroNode2
...
//            temp.next = temp.next.next;//单向链表删除方式
            ...
            System.out.println("要删除的 " + no + " 的节点不存在");
        }
    }
    ...
    public void addByOrder(HeroNode2 heroNode) {
        ...
        //判断flag的值
        if (flag) {//不能添加，说明编号存在
            System.out.println("准备插入的英雄的编号 " + heroNode.no + " 已经存在了，不能添加");
        } else {
            //插入到链表中，temp的后面
            temp.next = heroNode;
            heroNode.pre = temp;
